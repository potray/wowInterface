...
StubbyConfig = {
	["addinfo"] = {
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to disenchanting, prospecting, and milling results.  [5.21b.5509] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
