...
L.SpecWarn_NoSoundsWVoice	= "Do not play special warning sounds for warnings that have a voice option"
...
L.SpamBlockNoRunAway		= "Do not play 'run away' sounds"
...
L.HideApplicantAlerts		= "Supress applicant alerts in premade groups (changes require UI reload)"
