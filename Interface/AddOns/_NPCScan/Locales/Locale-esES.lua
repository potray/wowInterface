...
private.L["VIGNETTE_SCAN_DESC"] = "Muestra alertas para los NPC Señalizados .  Esta es una Característica Beta:  Actualmente no hay forma de filtrar los NPC, por lo que siempre saltará aunque un NPC no esté siendo buscado o ignorado."
