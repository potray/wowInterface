...
L["Act on Scan Results"] = "Guiarse por los resultados escaneados"
...
L["Add Items to this Group"] = "Añadir items a este grupo"
L["Additional error suppressed"] = "Error adicional suprimido"
L["Adjust Post Parameters"] = "Ajustar parámetros de publicación"
L["Advanced Option Text"] = "Opción de texto avanzada"
...
L["If checked, all tables listing auctions will display the bid as well as the buyout of the auctions. This will not take effect immediately and may require a reload."] = "Si se selecciona, todas las tablas de subastas listadas se mostrará la oferta, así como el precio decompra de las subastas. Esto no tendrá efecto inmediato y puede requerir una recarga."
...
L["<No Group Selected>"] = "<Sin Grupo Seleccionado>"
...
L["<No Operation Selected>"] = "<Sin Operación Seleccionada>"
