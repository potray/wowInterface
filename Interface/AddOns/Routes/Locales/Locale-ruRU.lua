...
L["CartographerExtractGas"] = "Извлечение газа" -- Needs review
L["CartographerFishing"] = "Рыбалка" -- Needs review
L["CartographerHerbalism"] = "Травничество" -- Needs review
L["CartographerMining"] = "Горное дело" -- Needs review
L["CartographerTreasure"] = "Сокровища" -- Needs review
...
L["Change direction"] = "Изменить направление" -- Needs review
L["Change direction (Carto)"] = "Изменить направление (Carto)" -- Needs review
L["Change direction (TomTom)"] = "Изменить направление (TomTom)" -- Needs review
L["Change the direction of the nodes in the route being added as the next waypoint"] = "Изменить направление узлов в маршрутах, добавляемых в качестве следующей точки" -- Needs review
...
L["GatherMateExtract Gas"] = "Извлечение газа" -- Needs review
L["GatherMateFishing"] = "Рыбалка" -- Needs review
L["GatherMateHerb Gathering"] = "Травничество" -- Needs review
L["GatherMateMining"] = "Горное дело" -- Needs review
L["GatherMateTreasure"] = "Сокровища" -- Needs review
...
L["Integrated support options for Cartographer_Waypoints"] = "Встроенная поддержка для Cartographer_Waypoints" -- Needs review
