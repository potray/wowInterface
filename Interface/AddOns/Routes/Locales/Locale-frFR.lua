...
L["Are you sure you want to recreate this route? This will delete all customized settings for this route."] = "Êtes-vous sûr de vouloir recréer cette route ? Cela supprimera tous les paramètres personnalisés de cette route." -- Needs review
...
L["Recreate Route"] = "Recréer la route" -- Needs review
L["Recreate this route with the same creation settings. NOTE: This only works for data from GatherMate2 and Gatherer."] = "Recréée cette route en utilisant les mêmes paramètres de création. NOTE : ceci ne fonctionne qu'avec les données provenant de GatherMate2 et Gatherer." -- Needs review
