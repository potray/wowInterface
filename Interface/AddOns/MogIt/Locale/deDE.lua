...
L["Preview frame fixed size"] = "Vorschau-Fenster mit fester Größe" -- Needs review
L["Preview frame UI panel behaviour"] = "Vorschau-Fenster vehält sich als UI Panel" -- Needs review
...
L["This will close all your currently open previews."] = "Dies wird alle offenen Vorschaufenster schließen." -- Needs review
...
L["Use a single preview frame"] = "Ein einzelnes Vorschau-Fenster benutzen" -- Needs review
L["Use custom model"] = "Benutzerdefiniertes Model nutzen"
L["Use preview frame to dress up"] = "Das Vorschau-Fenster zur Anprobe nutzen" -- Needs review
