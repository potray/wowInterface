...
DBM_CORE_BLIZZ_BUGS					= "6.0 애드온 오류 안내:\n1. 소리 설정에서 음향 효과가 설정되어 있을 경우, 전투 중에 애드온 소리가 나지 않을 수 있습니다. 이 현상은 6.0에서 애드온 소리 우선 순위가 낮게 설정되었기 때문에 나타납니다. 사운드 채널 수를 64로 높이거나, 음향 효과만 체크한 채로 나머지 효과들을 다 끄시면 해결 가능합니다. "
